...
export default function PlaceDashboardPage() {
  ...
  // Aggregate stats across all owned places
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            ...
            <StatCard
              icon={Heart}
              label="Favori Sayısı"
              value={totalFavorites > 0 ? totalFavorites.toString() : '—'}
              color="bg-red-100 text-red-500"
            />
            <StatCard
              icon={Bookmark}
              label="Listeleme Sayısı"
              value={totalWishlists > 0 ? totalWishlists.toString() : '—'}
